import {
    deleteTable, updateTable, addTable, getTable, postTableList, postTableListAndId,
    postMobileTableList, postMobileTableListAndId
} from "../../api/api";
...
export default {
    ...
    // 表格数据
    getRightTableDataComm (page, queryObject, tableFunc) {
        let para = {
            pageNo: page.page,
    ...
    getRightTableData (page, queryObject) {
        this.getRightTableDataComm(page, queryObject, !!queryObject.id ? postTableListAndId : postTableList);
    },

    getMobileRightTableData (page, queryObject) {
        this.getRightTableDataComm(page, queryObject, !!queryObject.id ? postMobileTableListAndId : postMobileTableList);
    },
