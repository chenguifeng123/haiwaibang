      ...
      <el-form :model="editForm" label-width="120px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item label="导航图编号" prop="fileList">
          ...
          >
            ...
            <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，推荐尺寸 640 * 270</div>
          </el-upload>
        </el-form-item>
...
import { getTableList, getMobileTableList, getTable, addTable, getUrlPath, getStaticReourcePath } from '../../api/api';
...
export default {
  ...
  methods: {
    ...
    editSuccess (res, file) {
      this.addImageData(res, false);
    },

    addSuccess (res, file) {
      this.addImageData(res, true);
    },

    //获取Banner
    getBanners () {
      util.getMobileRightTableData(this, { dataSetName: 'banners' });
    },
