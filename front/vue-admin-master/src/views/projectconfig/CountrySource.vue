  ...
  <section>
    ...
    <el-col :span="18" class="right-pannel" v-if="tableShow">
      ...
      >
        ...
        <el-table-column prop="countryId" label="项目编号" width="0" v-if="false"></el-table-column>
...
export default {
  data () {
    return {
      ...
      localHost: '',
      actionRootPath: '/manage/upload/doc/country/',
      action: '',            // 上传目录
  ...
  methods: {
    handleNodeClick (data) {
      ...
      if (data.leaf == 1) {
        ...
        if (this.currentCountryId != data.id) {
          this.getCountryDocSourceData(data.id);
          this.total = 0;
          this.page = 1;
          this.pageSize = 20;
    ...
    getTransferObject (object) {
      return util.fillPath(object, 'countryDocSource');
    },
    ...
    handleDel: function (index, row) {
      ...
      util.handleDel(this, index, row, function () {
        page.getCountryDocSourceData(page.currentCountryId);
      });
    },
    //显示编辑界面
